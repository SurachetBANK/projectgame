...
Counting0.prototype = proto;

Counting0.prototype.create = function() {
...
/*
 * function NextLevel() { this.game.state.start("Level1", true, false,
 * this.BGmusic); }
 */
...
Counting0.prototype.addPlayer = function(x, y) {
...
Counting0.prototype.addCount = function(x, y) {
