...
Level.prototype.addEGame = function(x, y) {
...
Level.prototype.addEWY = function(x, y) {
...
Level.prototype.addEWeed = function(x, y) {
...
Level.prototype.onCollidePlayerPoint = function(player, Gpoint) {
	Gpoint.kill();
...
Level.prototype.onCollidePlayerEnemy = function(player, enemies) {
	player.canHit = false;
