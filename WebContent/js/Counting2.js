...
Counting2.prototype = proto;

Counting2.prototype.create = function() {
...
Counting2.prototype.NextY = function() {
	this.ConDrum.stop();
	this.wow.stop();
	this.kid.stop();
	this.ho.stop();
...
Counting2.prototype.Resi = function() {
	this.ConDrum.stop();
	this.wow.stop();
	this.kid.stop();
	this.ho.stop();
...
Counting2.prototype.addPlayer = function(x, y) {
...
Counting2.prototype.addCount = function(x, y) {
