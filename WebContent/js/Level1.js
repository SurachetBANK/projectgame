...
Level1.prototype.addPlayer = function(x, y) {
...
Level1.prototype.addEGame = function(x, y) {
...
Level1.prototype.addEWY = function(x, y) {
...
Level1.prototype.addEWeed = function(x, y) {
...
Level1.prototype.onCollidePlayerPoint = function(player, Gpoint) {
	Gpoint.kill();
...
Level1.prototype.onCollidePlayerEnemy = function(player, enemies) {
	player.canHit = false;
